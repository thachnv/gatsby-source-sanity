...
function getDocumentStream(url, token) {
    var _this = this;
    var headers = __assign({ 'User-Agent': "".concat(index_1.pkgName) }, (token ? { Authorization: "Bearer ".concat(token) } : {}));
    return (0, axios_1.default)({
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, (0, get_stream_1.default)(err.response.data)];
                case 2:
                    data = _a.sent();
